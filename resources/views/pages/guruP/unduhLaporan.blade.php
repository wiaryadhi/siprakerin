    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal form-label-left" action="{{ route('unduhLaporan') }}" method="POST">
                        @csrf
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Pilihan
                                Industri</label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <select name="industri_id" class="form-control js-example-basic-single">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <button type="submit" class="btn btn-warning">Unduh</button>
                            </div>
                        </div>
                    </form>
                </div>
