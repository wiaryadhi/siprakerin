    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal form-label-left"
                action="{{ route('editDataPendaftaran', ['id' => $pendaftaran->id]) }}" method="POST">
                @csrf
                <div class="form-group row mb-4">
                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">NIS</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" name="pendaftaran" id="nama"
                            value="{{ $pendaftaran->nis }}" disabled="true">
                    </div>
                </div>
                <div class="form-group row mb-4">
