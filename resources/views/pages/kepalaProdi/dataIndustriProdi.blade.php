                        ...
                        <table id="datatable" class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                        <a href="/detailIndustriProdi/{{ $eachdata->id }}">
                                                <button type="submit" class="btn btn-warning btn-md"
                                                    data-toggle="tooltip" data-placement="bottom" title="Detail">
                                                    <i class="fas fa-search"></i></button>
                                            </a>
                                            <a href="/editIndustriProdi/{{ $eachdata->id }}">
                                                <button type="submit" class="btn btn-success btn-md"
                                                    data-toggle="tooltip" data-placement="bottom" title="Edit">
                                                    <i class="fas fa-edit"></i></button>
                                            </a>
                                            <a href="#">
                                                <button type="sumbit" class="btn btn-danger btn-md delete"
...
<script>
    $('.delete').click(function () {
        ...
        Swal.fire({
            ...
            if (result.value) {
                window.location = "/dataIndustriProdi/"+ industri_id;
                Swal.fire(
                    'Terhapus!',
